    ...
    function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            function(e, n) {
                ...
                t += r(e.name),
                //MAEDA AKATSUKI   添加了一个删除的ICON
                // t += '</span>\n    <span class="glyphicon glyphicon-trash removeMusic">',
                //MAEDA AKATSUKI
        ...
        var l = function() {
            ...
            return i(e, [{
                ...
                value: function() {
                    ...
                    //     //下标从0开始。显示是从1开始
                    //     e.player.list.remove(index-1);
                    //     console.log("我被大佬打了")
                    //     /* 
                    //         return 掉就不会执行下面的代码了，
                    //         避免了点击删除icon，还会触发列表点击播放事件 
                    //     */
                    //     return ;
                    // })
                    //MAEDA AKATSUKI
            ...
            },
            {
                ...
                value: function(e) {
                    if (this.player.events.trigger("listremove", {
                        ...
                        //MAEDA AKATSUKI
                        /*  修复了ap.list.clear();函数造成的'TypeError: this.lrc is undefined' BUG
                            源代码为 this.lrc.splice(e, 1),
                        */
                        this.player.lrc.parsed.splice(e, 1),
                        //MAEDA AKATSUKI
            ...
            },
            {
                ...
                value: function() {
                    ...
                    //MAEDA AKATSUKI 
                    /*  修复了ap.list.clear();函数造成的'TypeError: this.lrc is undefined' BUG
                        源代码为 this.lrc.parsed = [];
                    */
                    this.player.lrc.parsed = [],
                    //MAEDA AKATSUKI
                    ...
                    this.player.template.title.innerHTML = "列表为空",
                ...
                value: function(e) {
                    ...
                    if (!this.parsed[e]) if (this.async) {
                        ...
                        n.onreadystatechange = function() {
                            e === t.player.list.index && 4 === n.readyState && (n.status >= 200 && n.status < 300 || 304 === n.status ? t.parsed[e] = t.parse(n.responseText) : (t.player.notice("LRC file request fails: status " + n.status), t.parsed[e] = [["00:00", "纯音乐，请说出你的故事"]]), t.container.innerHTML = (0, o.
                        default)({
                                lyrics:
                                t.parsed[e]
                        ...
                        n.open("get", i, !0),
                        n.send(null)
                    } else this.player.list.audios[e].lrc ? this.parsed[e] = this.parse(this.player.list.audios[e].lrc) : this.parsed[e] = [["00:00", "纯音乐，请说出你的故事"]];
...
//# sourceMappingURL=APlayer.min.js.mapcover
